...
class CNN():
    ...
    def generate_model(self):
        ...
        model.add(tf.keras.layers.Conv2D(32, (3, 3), activation='relu', input_shape=(256, 256, 3)))  # Input Shape: 256x256x3
        ...
        if self.optimizer == "SGD":
            ...
            #añadir momentum y decay a los parameteros, en función de si llamamos al SGD o al RMS prop
